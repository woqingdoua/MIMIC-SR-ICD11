# -*- coding: utf-8 -*-
"""
LoRA finetune MedFound-Llama3-8B-finetuned on patient self-reports → ICD-11 title
...
# ============== Model / Tokenizer ==============
model_name = "medicalai/MedFound-Llama3-8B-finetuned"  # Llama 3 架构
tokenizer = AutoTokenizer.from_pretrained(
    model_name,
    trust_remote_code=True,
    use_fast=True
)
# Llama3 没有 pad_token，用 eos 充当
...
model.config.use_cache = False  # 以便与 gradient checkpointing 兼容

# ============== LoRA config (Llama 系列常用模块) ==============
...
#SYSTEM = ("You are a diagnostic assistant. Read the patient self-report and output "
#          "the SINGLE most likely diagnosis as an ICD-11 title. Return ONLY the title.")

def preprocess(example):

    prompt = (
        #f"{SYSTEM}\n\n"
        f"Patient report: {example['report']}\n"
        f"Diagnosis:"
    )
...
training_args = TrainingArguments(
    output_dir="./medfound_llama3_8b_lora",
...
# ============== Save LoRA adapter ==============
save_dir = "model/medfound8b_disease_finetuned"
