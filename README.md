...
> This repository displays the construction as Figure 2 from the paper. Please place the exported image at `figure2.pdf` (or update the path below).

![Data construction pipeline (Figure 2)](figure2.pdf)
